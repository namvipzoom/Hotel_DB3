...
public class QL_KhuyenMai extends javax.swing.JInternalFrame {
    ...
    private void btn_SuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_SuaActionPerformed
        ...
        String tb = "";
        if (txt_TenKhuyenMai.getText().length() == 0) {
            tb += "Tên khuyến mãi không được để trống";
        }
        if (!check.isNumeric(txt_GiaTri.getText())) {
            tb += "Giá trị phải là số";
        }
        if (txt_TenKhuyenMai.getText().length() > 0 && check.isNumeric(txt_GiaTri.getText())) {
