...
public class QL_KhachHang extends javax.swing.JInternalFrame {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txt_SoLuot, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(1, 1, 1)
    ...
    private void btn_SuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_SuaActionPerformed
        ...
        if (txt_TenKhachHang.getText().length() == 0) {
            tb+="Tên dịch vụ không được để trống \n";
        }
        if (!check.isNumeric(txt_CMND.getText())) {
            tb+="Số CMND phải là số\n";
        }
        ...
        if (check.isNumeric(txt_SoLuot.getText()) && check.isNumeric(txt_DienThoai.getText()) && check.isNumeric(txt_CMND.getText()) && txt_TenKhachHang.getText().length()>0) {
